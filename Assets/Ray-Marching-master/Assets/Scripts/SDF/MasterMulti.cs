...
public class MasterMulti : MonoBehaviour {
    ...
    void InitRenderTexture () {
        ...
        //     }
        //     depthTexture = new RenderTexture (cam.pixelWidth, cam.pixelHeight, 0, RenderTextureFormat.ARGBFloat, RenderTextureReadWrite.Linear);
